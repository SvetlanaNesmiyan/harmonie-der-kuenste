             ...
             {navItems.map((item) => (
               <li key={item.name} className="relative">
                 {item.name === "CLASSES" ? (
                   ...
                   <Link
                     href={item.href}
                     onClick={item.name === "ABOUT" ? handleAboutClick : item.name === "CONTACT" ? handleContactClick : undefined}
                     className="text-white text-sm font-medium hover:text-primary transition-colors flex items-center gap-1"
                   >
                     {item.name}
               ...
               {navItems.map((item) => (
                <li key={item.name}>
                  {item.name === "CLASSES" ? (
                    ...
                    <Link
                      href={item.href}
                       onClick={item.name === "ABOUT" ? handleAboutClick : item.name === "CONTACT" ? handleContactClick : () => setMobileMenuOpen(false)}
